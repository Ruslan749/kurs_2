...
Сначала программа использует метод connect() из библиотеки Jsoup для получения HTML-кода страницы. Затем, с помощью метода select(), программа извлекает список новостей из HTML-кода.
Для каждой новости в списке программа выводит в консоль ее тему и дату. Для этого она применяет методы getElementsByClass() и childNodes() из библиотеки Jsoup.
 */
package HTML;
